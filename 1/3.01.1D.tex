...
\begin{minipage}{\textwidth}
    \centering
    \includegraphics[scale=0.9]{images/01_replica-set-read-write-operations-primary.jpg}
...
\begin{minipage}{\textwidth}
    \centering
    \includegraphics[scale=0.9]{images/01_sharded-cluster-scatter-gather-query.jpg}

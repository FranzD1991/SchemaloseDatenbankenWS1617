...
%\begin{figure}[h]
%	\centering
%	\includegraphics[scale=0.7]{images/Datenmodell_Mongo.jpg}  
...
%\begin{figure}[h]
%	\centering
%	\includegraphics[scale=0.7]{images/replica-set-read-write-operations-primary.jpg}  
...
%\begin{figure}[h]
%	\centering
% 	\includegraphics[scale=0.7]{images/sharded-cluster-production-architecture.jpg} 
...
%\begin{figure}[h]
%	\centering
%	\includegraphics[scale=0.7]{images/sharded-cluster-scatter-gather-query.jpg} 
